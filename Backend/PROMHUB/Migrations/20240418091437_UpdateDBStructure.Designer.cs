...
namespace PROMHUB.Migrations
{
    ...
    [Migration("20240418091437_UpdateDBStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PROMHUB.Data.Models.ProductGet", b =>
                {
                    b.HasOne("PROMHUB.Data.Models.ProductShop", "ProductShop")
                        .WithMany()
            ...
            modelBuilder.Entity("PROMHUB.Data.Models.ProductShop", b =>
                {
                    b.HasOne("PROMHUB.Data.Models.Product", "Product")
                        .WithOne("ProductShop")
                        .HasForeignKey("PROMHUB.Data.Models.ProductShop", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PROMHUB.Data.Models.Shop", "Shop")
                        .WithOne("ProductShop")
                        .HasForeignKey("PROMHUB.Data.Models.ProductShop", "ShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
